...
shipped_gz_manifest <- list(
  ...
  list(path = "01_datasets/processed/population_adm2_ghspop_interpolated.csv", phases = c("core", "extension")),
  list(path = "01_datasets/processed/ntl/harmonized_dmsp_viirs_adm2_panel.csv", phases = c("core", "supplementary", "extension")),
