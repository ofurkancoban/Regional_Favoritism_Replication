...
#
# Description:   Downloads raw VIIRS annual nighttime-lights composites (EOG VNL v2 family, average_masked band) directly from eogdata.mines.edu, without Google Earth Engine.
#
# Inputs:        EOG (eogdata.mines.edu) credentials
# Outputs:       01_datasets/raw/viirs_raster_eog_manual/
# ==============================================================================
...
out_root <- here::here("01_datasets/raw/viirs_raster_eog_manual")
