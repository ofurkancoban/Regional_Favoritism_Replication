...
#
# Description:   Authenticates against EOG Keycloak and downloads all DMSP-OLS Version 4 stable_lights GeoTIFFs (1992-2013). Resume-safe: skips files already present.
#
# Inputs:        EOG (eogdata.mines.edu) credentials
# Outputs:       01_datasets/raw/dmsp_raster_eog_manual/
# ==============================================================================
...
out_root <- here::here("01_datasets/raw/dmsp_raster_eog_manual")
