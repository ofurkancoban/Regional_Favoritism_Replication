...
#
# Description:   Downloads and validates GADM 4.1 administrative boundaries (Turkey ADM1 pipeline test, and global ADM2 GeoPackage used for the main replication panel).
#
# Inputs:        GADM 4.1 GeoPackage URLs (geodata.ucdavis.edu)
# Outputs:       01_datasets/raw/gadm_4.1/
# ==============================================================================
...
turkey_gpkg      <- here::here("01_datasets/raw/gadm_4.1/turkey/gadm41_TUR.gpkg")
turkey_ne_gpkg   <- here::here("01_datasets/raw/gadm_4.1/turkey/naturalearth_TUR_1.gpkg")

gb_adm1 <- here::here("01_datasets/raw/gadm_4.1/turkey/geoboundaries_TUR_ADM1.geojson")
gb_adm1_url <- paste0(
...
download_geoboundaries <- function(iso3, level = "ADM2",
                                   outdir = here::here("01_datasets/raw/gadm_4.1/global/geoboundaries")) {
...
global_gadm_zip <- here::here("01_datasets/raw/gadm_4.1/global/gadm_410-levels.zip")
global_adm2_shp <- here::here("01_datasets/raw/gadm_4.1/global/gadm_410-levels/gadm_410-2.shp")
