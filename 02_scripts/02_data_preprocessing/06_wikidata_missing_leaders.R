# ==============================================================================
# File:          06_wikidata_missing_leaders.R
...
#
# Description:   Identifies leaders PLAD has no birthplace coordinates for, to be manually supplemented from Wikidata (see reference_data/wikidata_supplement_*.csv).
#
# Inputs:        01_datasets/raw/plad/PLAD_April_2024.tab
# Outputs:       01_datasets/processed/wikidata_missing_leaders.csv
# ==============================================================================
...
data.table::fwrite(leaders, here::here("01_datasets/processed/wikidata_missing_leaders.csv"))
