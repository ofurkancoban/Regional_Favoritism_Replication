# 02_scripts/04_tools/local_ntl_extraction.R
...
# validated for the grid-cell extraction (13_dmsp_grid_cells_extraction.R):
#
...
#     exactextractr::exact_extract() reads only each polygon's own bounding-box window,
