...
lookup <- data.table::fread("data/processed/birthplace_circles_lookup_plad_only.csv")
ntl <- data.table::fread("data/processed/ntl/dmsp_circles_panel_plad_only.csv")
...
saveRDS(m1, file.path(out_dir, "table4_col1_circles_model_plad_only.rds"))
cat(sprintf("\nModel saved: %s\n", file.path(out_dir, "table4_col1_circles_model_plad_only.rds")))
